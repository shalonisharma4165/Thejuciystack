...
<html>
    ...
    <body>
        ...
        <div class=" menu container d-flex justify-content-around align-items-center">
            <a class="main-btn" href="AHome.jsp"> View Users</a>
            <a class="main-btn act" href="VOrders.jsp">View Orders</a>
        </div>
        <%
        ...
        <section>
            ...
            <% } else {
                PreparedStatement user = con.prepareStatement("SELECT * FROM registration where Email=?");
                user.setString(1,rs.getString(2));
                ResultSet rs1 = user.executeQuery();
                if (rs1.next()) {
            %>
            <div class="container d-flex justify-content-center align-items-center">
                <table class="table table-striped table-dark my-5" style="margin-top: 30px;">
                    ...
                    <tr>
                        ...
                        <th class="td" scope="row"><span style=" text-transform: capitalize"><%= rs1.getString(2)%></span></th>
